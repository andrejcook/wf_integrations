...
export interface ApiAppApp extends Schema.CollectionType {
  ...
  attributes: {
    ...
    client_secret: Attribute.String & Attribute.Required;
    scope: Attribute.String & Attribute.Required;
    details: Attribute.Text;
    app_credentials: Attribute.Relation<
      'api::app.app',
      'oneToMany',
...
export interface ApiAppCredentialAppCredential extends Schema.CollectionType {
...
export interface ApiEmailTemplateEmailTemplate extends Schema.CollectionType {
  ...
  attributes: {
    template_id: Attribute.Integer & Attribute.Required & Attribute.Unique;
    subject: Attribute.String & Attribute.Required;
    template: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiIntegrationFlowIntegrationFlow
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    app: Attribute.Relation<
      ...
      'api::app.app'
    >;
    integration_logs: Attribute.Relation<
      'api::integration-flow.integration-flow',
      'oneToMany',
...
export interface ApiIntegrationFlowDetailIntegrationFlowDetail
  extends Schema.CollectionType {
  ...
  attributes: {
    last_run_date: Attribute.DateTime;
    status: Attribute.Enumeration<
      ['Running', 'Stopped', 'Sleeping', 'Terminated']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Stopped'>;
    last_transform_data: Attribute.JSON;
    snapshot_value: Attribute.String;
    integration_flow: Attribute.Relation<
      'api::integration-flow-detail.integration-flow-detail',
      'oneToOne',
      'api::integration-flow.integration-flow'
    >;
...
export interface ApiIntegrationLogIntegrationLog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    integration_flow: Attribute.Relation<
      ...
      'api::integration-flow.integration-flow'
    >;
    status: Attribute.Enumeration<['Completed', 'Failed']>;
    dataSync: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::integration-log.integration-log',
