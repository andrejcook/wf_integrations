...
import { useGetsCollection } from '@/data/webflow';
...
const MappingDataComponent: React.FC<Props> = ({
  register,
  errors,
  control,
  apiResponse,
        ...
        <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
          ...
          <Card className="w-full ">
            <AdvancedFieldMapping
              ...
              disableSplitter={disableSplitter}
            />
          </Card>
        </div>
      )}
    ...
    <div>
      ...
      {fieldMapping.disableSplitter && (
        <div className="flex">
          <div className="w-1/2 flex">
            <div className="w-1/2 p-2">
              {arrayKeysArrayoptions && <div className="mb-5"></div>}{' '}
            </div>
            <div className="w-1/2 p-2">
              {refFields && <div className="mb-5"></div>}
            </div>
          </div>
          <div className="w-1/2 flex">
